...
public class JTrackPlannerNewProjectBox extends JDialog implements ActionListener {
    ...
    private void jbInit() throws Exception {
        ...
        projectLibrary = new JComboBox(new Vector<File>(libLoader.getLibraryList()));
    ...
    /**
     * Check if all required fields are well filled
     * @return true if fields are well filled, false otherwise
     */
    ...
    /**
     * Returns the project library name
     * @return The project library name
     */
    public String getLibraryName() {
        return ((File) (projectLibrary.getSelectedItem())).getName();
    }
    
    /**
     * Returns the project library file
     * @return Yhe project library file
     */
    public File getLibraryFile() {
        return (File) projectLibrary.getSelectedItem();
    }
}
